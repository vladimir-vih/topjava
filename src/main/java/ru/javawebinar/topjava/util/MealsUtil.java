...
public class MealsUtil {
    ...
    public static final List<Meal> meals1 = Arrays.asList(
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 29, 10, 0),
                    "Завтрак", 500),
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 29, 13, 0),
                    "Обед", 1500),
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 29, 20, 0),
                    "Ужин", 500),
