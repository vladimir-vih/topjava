...
public class User extends AbstractNamedEntity {
    ...
    public User(Integer id, String name, String email, String password, Role... roles) {
        this(id, name, email, password, DEFAULT_CALORIES_PER_DAY, true, new Date(), Collections.emptyList(), Arrays.asList((roles)));
    }

    public User(Integer id, String name, String email, String password, List<Meal> meals, Role... roles) {
        this(id, name, email, password, DEFAULT_CALORIES_PER_DAY, true, new Date(), meals, Arrays.asList((roles)));
    }
